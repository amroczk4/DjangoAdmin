...
from .game import create_puzzle_answer, get_hints
...
def test(request):
    ...
    guess_sim = choice(dishes)
    hints = get_hints(guess_sim, answer)
    return render(request=request, template_name='foodrle/test.html', context={"dishes":dishes, "guess": guess_sim, "answer": answer.name, "hints": hints})
