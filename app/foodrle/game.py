...
def country_hint(answer_country: Country, guessed_country: Country):
    country_hint = str(guessed_country.distance(answer_country)) + ' miles'
    country_hint = country_hint + ' ' + guessed_country.direction(answer_country)
    print('\tFrom a country',country_hint,f'of {guessed_country}')


def main_ingredient_hint(answer: Dishes, guess_dish: Dishes):
    guess_main_ingr = guess_dish.main_ingredient
    if answer.main_ingredient == guess_main_ingr:
...
def taste_hint(answer: Taste, guess_dish: Taste):
    # stuff
    print("\t<Placeholder for Taste Hint>")
